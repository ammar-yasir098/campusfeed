...
import {
  ...
  ThumbsUp, MessageCircle, Megaphone, X, ChevronRight, Sparkles, Filter
} from 'lucide-react';
...
const NotifIcon = ({ type }) => {
  const styles = {
    like: {
      ...
      border: '#93c5fd',
      icon: <ThumbsUp size={16} color="#1d4ed8" />
    },
    comment: {
      bg: 'linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%)',
      border: '#6ee7b7',
      icon: <MessageCircle size={16} color="#047857" />
    },
    announcement: {
      bg: 'linear-gradient(135deg, #fef3c7 0%, #fde68a 100%)',
      border: '#fcd34d',
      icon: <Megaphone size={16} color="#b45309" />
    },
  };
  ...
  return (
    <>
      ...
      <div style={{
        ...
        maxWidth: '100vw',
        background: '#ffffff',
        boxShadow: '-10px 0 50px rgba(15, 23, 42, 0.18)',
        zIndex: 999,
        display: 'flex',
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem' }}>
              ...
              <div>
                ...
                <span style={{ fontSize: '0.72rem', color: '#93c5fd', opacity: 0.9 }}>
        ...
        <div style={{ overflowY: 'auto', flex: 1, padding: '1rem', background: '#f8fafc' }}>
          {loading && notifications.length === 0 ? (
            ...
            <div style={{
              ...
              <div style={{
                ...
                justifyContent: 'center', margin: '0 auto 1.2rem auto',
                border: '1px solid #bfdbfe'
              }}>
                <BellOff size={28} color="#2563eb" />
              </div>
              <h4 style={{ fontWeight: 800, fontSize: '1.05rem', color: '#0f2942', margin: '0 0 0.4rem 0' }}>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      padding: '1rem 1.1rem',
                      borderRadius: '14px',
                      background: isUnread ? '#ffffff' : 'rgba(255, 255, 255, 0.75)',
                      border: '1px solid',
